    ...
    <div class="box">
        <div class="head">
            <div class="head-con">
                ...
                <ul class="head-lis">
                    <li class="head-lis-active"><a href="http://school/?school=ayst">首页</a>
                        <div class="line"></div>
                    </li>
        ...
        <div class="s-content">
            <div class="s-slider">
                <div class="swiper-wrapper s-img">
                    <div class="swiper-slide s-slide1 aystBanner"></div>
                    <!-- <div class="swiper-slide s-slide2"></div> -->
                </div>
            </div>
            <div class="s-intro">
                <div class="s-intro-head">
                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/school/logo_ayst.png" alt="" data-aos="flip-up" data-aos-duration="600">
                    <h3 data-aos="fade-down" data-aos-duration="600">育人宝贝幼儿园</h3>
                    <h4 data-aos="fade-down" data-aos-duration="600">国际化 · 优质化 · 特色化</h4>
                </div>
                <div class="s-intor-con" data-aos="fade-up" data-aos-duration="600">
                    <div class="s-intor-con-left">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/school/logo_ayst.png" alt="">
                    </div>
                    <div class="s-intro-con-rig">
                        <p>育人宝贝幼儿园以“培养孩子带得走的能力”为使命，拥有专业的师资团队，以及创新型教学模式。我们根据幼儿成长特点，
                            增加幼儿社会实践课程，不仅让孩子们增长见识，还能让他们从中获得更多更真实的社会体验。</p>
                            <p>我们建立了一座幸福的城堡，为孩子们的梦想插上翅膀，让他们勇敢、快乐的成长。</p>
                            <p>育人宝贝幼儿园秉持郑州育人教育集团的教育理念——以人为本，因材施教。本园引进台湾学前教育的卓越绩效，善用本地幼儿教育的优势基础，
                                结合两岸的专业师资团队，朝着结合中西方文化精髓、国际化、精致化的学园发展。</p>
                ...
                <ul class="s-choice-con clearfix">
                    <li data-aos="fade-up" data-aos-duration="500">
                        <div class="s-choice-lis">
                            ...
                            <div class="s-choice-p">
                                <p>以品德第一，全人发展的教育愿景，园所的学习范畴涵盖语文、科学、生活、生态、体能及艺术等认知，
                                    技能及情意，统涉人与自我，人与社会及人与自然等三大面向，是个全方位的学习乐园。
                                </p>
                            </div>
                        </div>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="200">
                        <div class="s-choice-lis">
                            ...
                            <h4>亲子共学 资源共享</h4>
                            <div class="s-choice-p">
                                <p>育人宝贝幼儿园为落实亲子共学及三代同堂等天伦之乐，特别设置家庭教育中心，绘本图书馆及感觉统合教室等资源中心，
                                    把优质资源提供给本园师生及社区民众，成为另一个校外学习的新场所，这将会是一所健康、艺术与大小共学的生态园。
                                </p>
                            </div>
                        </div>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="400">
                        <div class="s-choice-lis">
                            <div class="s-choice-icon"><i class="iconFont">&#xe7bd;</i></div>
                            <h4>独一无二 全面培养</h4>
                            <div class="s-choice-p pindex">
                                <p>小班化教学，让每个孩子得到更多的关注与呵护</p>
                                <p>专业的师资，保证孩子的个性化成长</p>
                                <p>优质外教资源，增强孩子学习英语的兴趣及能力</p>
                                <p>国际化课程体系，让孩子拥有更开阔的视野</p>
                                <p>多元化教学模式，科学培养孩子的多种能力</p>
                            </div>
                        </div>
                    </li>
                </ul>
