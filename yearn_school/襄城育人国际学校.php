    ...
    <div class="box">
        <div class="head">
            <div class="head-con">
                ...
                <ul class="head-lis">
                    <li class="head-lis-active"><a href="http://school/?school=xcyr">首页</a>
                        <div class="line"></div>
                    </li>
        ...
        <div class="s-content">
            <div class="s-slider">
                <div class="swiper-wrapper s-img">
                    <div class="swiper-slide s-slide1 xcyrBanner"></div>
                    <!-- <div class="swiper-slide s-slide2"></div> -->
                </div>
            </div>
            <div class="s-intro">
                <div class="s-intro-head">
                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/school/logo_xcyr.png" alt="" data-aos="flip-up" data-aos-duration="600">
                    <h3 data-aos="fade-down" data-aos-duration="600">襄城育人国际学校</h3>
                    <h4 data-aos="fade-down" data-aos-duration="600">不鸣则已 一鸣惊人</h4>
                </div>
                <div class="s-intor-con" data-aos="fade-up" data-aos-duration="600">
                    <div class="s-intor-con-left">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/school/logo_xcyr.png" alt="">
                    </div>
                    <div class="s-intro-con-rig">
                        <p>襄城育人国际学校，校内分设小学部、中学部和高中部，每个教室都安装了白板教学系统，为高效课堂提供了有力的硬件保障。在省内权威专家的引领下，郑州名师与许昌名师互动了起来，使两校教师分享了优质的教育资源，在教研中拉起手共同追教育梦，圆教育梦。</p>
                        <p>学校未来的发展方向以国际化的视野开阔师生的思想，建立国际学校的校园文化，构建国际教育课程体系，引进量化评价系统，完善课程管理和评价。</p>
                        <!-- <p>学校未来的发展方向以国际化的视野开阔师生的思想，建立国际学校的校园文化，构建国际教育课程体系，引进量化评价系统，完善课程管理和评价。</p> -->
                    </div>
                </div>
            </div>
                ...
                <ul class="s-choice-con clearfix">
                    <li data-aos="fade-up" data-aos-duration="500">
                        <div class="s-choice-lis">
                            ...
                            <div class="s-choice-p">
                                <p>建立各学段教研共同体，统一贯通教师的教学思想和行为。打通各学段教研活动，使教师明确了学生远期发展目标及前期学、知、行的基础，有了这样的了解，教师的教学行为更有的放矢，更高效，更有助于学生的健康成长。</p>
                            </div>
                        </div>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="200">
                        <div class="s-choice-lis">
                            ...
                            <h4>横向拓展 逐项推进</h4>
                            <div class="s-choice-p">
                                <p>建立园际、校际间的教研共同体，各显特色，优势互补。以“加强团队建设，规范管理，凝心聚力”为落地工程；以“加强文化建设，内提品质，外树形象”为生根工程；以“加强课程建设，科研促发展”为内涵生长工程，三条主线，三项工程，脚踏实地逐项推进落实。</p>
                            </div>
                        </div>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="400">
                        <div class="s-choice-lis">
                            ...
                            <h4>立足传统 融合中西</h4>
                            <div class="s-choice-p">
                                <p>在课程体系建设中以中国传统文化为根本，融合西方教育思想，确立既有中国传统文化的含蓄典雅，又有西方文化的开放、自由的国际学校文化，既凸显认知学科的课程的价值，又着力在科学和实践课程中形成的科学态度和实践能力。
                                </p>
                            </div>
                        </div>
                    </li>
            ...
            <div class="section s-show" id="schoolShow">
                ...
                <div data-aos="fade-up" data-aos-duration="500">让生命与使命同行，用行动擦亮教育梦想天空</div>
                <ul class="s-show-con">
...
<script>
    function createMap() {
        ...
        var point = new BMap.Point(113.494818, 33.877555);
        map.centerAndZoom(point, 15);
        window.map = map;
    }
    var markerArr = [{
        title: "襄城育人国际学校",
        content: "电 话：0371-55261585<br>地 址：河南省许昌市襄城县库庄镇首山大道育人国际学校东北门",
        point: "113.494818|33.877555",
        isOpen: 1,
        icon: {
            w: 23,
            h: 25,
