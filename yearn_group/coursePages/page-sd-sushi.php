...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/css/course.css">
</head>
<body>
<div class="head">
<div class="head-con">
    ...
    <ul class="head-lis">
        ...
        <ul class="mDropdown">
            <li class="mdrop">
                <a href="#" target="_blank">iDOL</a>
            </li>
            <li class="mdrop">
                <a href="#" target="_blank">育人往事</a>
            </li>
            <li class="mdrop">
                <a href="#" target="_blank">朗读者</a>
            </li>
        </ul>
...
<div class="c-box">
    ...
    <div class="c-con">
        <div class="c-title">
            ...
            <p class="icontitle">西点寿司</p>
        </div>
        <p>寿司是近几年国内最流行的美食之一，最早流传于日本，以简单为美味，以自然为美味，日本料理之所以逐渐在世界各地蔚然成风，受到越来越多人的喜爱，原因在此。而这其中，寿司尤其是这种美食简约哲学的极致表现。以简单为美味，以自然为美味，日本料理之所以逐渐在世界各地蔚然成风，受到越来越多人的喜爱，原因在此。而这其中，寿司尤其是这种美食简约哲学的极致表现。</p>
        <div class="grade">
            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/grade.png">
            <span>学段：3-12年级</span>
        </div>
        <!--<ul class="provider">
            <li class="item">
