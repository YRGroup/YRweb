...
<div class="c-box">
    ...
    <div class="c-con">
        <div class="c-title">
            ...
            <p class="icontitle">舞蹈</p>
        </div>
        <p>舞蹈的健身动作爆发力强，对人体体能潜力开发性强，舞蹈能较好地改善练习者的协调能力。
        舞蹈是一种极具表现力的运动，通过舞蹈课程，学生们可以表现自己的同时培养了自信和气质。
        跳舞是一种静中有动、动中有静的健身方式，可以缓解神经肌肉紧张。据专家测定，当烦躁、焦虑的情绪涌向心头时，
        以轻快的步伐15分钟左右，即可缓解紧张，稳定情绪。</p>
        <div class="grade">
