        ...
        <div class="s-content">
            <div class="s-slider">
                <div class="swiper-wrapper s-img">
                    <div class="swiper-slide s-slide1 babyBanner"></div>
                    <!-- <div class="swiper-slide s-slide2"></div> -->
                </div>
            </div>
            <div class="s-intro">
                <div class="s-intro-head">
                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/school/logo_baby.png" alt="" data-aos="flip-up" data-aos-duration="600">
                    <h3 data-aos="fade-down" data-aos-duration="600">e-BABY 台湾精致早教</h3>
                    <h4 data-aos="fade-down" data-aos-duration="600">因为爱，懂宝贝才能更爱宝贝！</h4>
                </div>
                <div class="s-intor-con" data-aos="fade-up" data-aos-duration="600">
                    <div class="s-intor-con-left">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/school/logo_baby.png" alt="">
                    </div>
                    <div class="s-intro-con-rig">
                        <p>e-BABY台湾精致早教创始于2002年，作为台湾早教先驱的e-BABY，一直以来肩负的教育使命就是致力于专业的教育，
                        为孩子设计科学化、适龄、适性、量身定做的教学系统。</p>
                        <p>e-BABY与家长密切互动，传达对每一位宝贝的爱与尊重，以及对家庭教育的重视，并坚信“孩子要成长的好，
                        父母亲必须跟着成长”的理念，来推动“父母成长营”等家庭教育服务。</p>
                    </div>
                </div>
            </div>
            ...
            <div class="s-choice">
                ...
                <ul class="s-choice-con clearfix">
                    <li data-aos="fade-up" data-aos-duration="500">
                        <div class="s-choice-lis w400">
                            <div class="s-choice-icon"><i class="iconFont">&#xe60d;</i></div>
                            <h4>教育使命 专业服务</h4>
                            <div class="s-choice-p">
                                <p>e-BABY一直以来肩负的教育使命，就是致力于专业的教育，为孩子设计科学化、适龄、适性、量身定做的教学系统；
                                加上与家长密切互动，传达的是对每一位宝贝的爱与尊重，以及对家庭教育的中式，并坚信“孩子要成长的好，
                                父母亲必须跟着成长”的理念，来推动如父母成长营的家庭教育服务。</p>
                            </div>
                        </div>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="200">
                        <div class="s-choice-lis w400">
                            ...
                            <h4>创新思维 科学验证</h4>
                            <div class="s-choice-p">
                                <p>e-BABY积极与两岸学术、医学专业进行交流与学习，与多所高校进行产学合作，成立产业学院，
                                进一步提升专业并同时培育人才。开发出的“ELITE云端检测系统”，以客观、科学的脑研究为主题，
                                运用科学化评测工具，设计幼儿教育实验理论应用之教育课程，开启幼儿大脑的学习潜能，铸就高端精致幼儿早教品牌。
                                </p>
                            </div>
                        </div>
                    </li>
                    <!-- <li data-aos="fade-up" data-aos-delay="400">
                        <div class="s-choice-lis">
                            ...
                            <h4>构建国际教育课程体系</h4>
                            <div class="s-choice-p">
                                <p>学校未来的发展方向以国际化的视野开阔师生的思想，建立国际学校的校园文化，构建国际教育课程体系，引进量化评价系统，完善课程管理和评价。
                                </p>
                            </div>
                        </div>
                    </li> -->
            ...
            <div class="section s-show" id="schoolShow">
                ...
                <div data-aos="fade-up" data-aos-duration="500">一切从『爱是唯e』开始</div>
                <ul class="s-show-con">
...
<script>
    function createMap() {
        ...
        var point = new BMap.Point(113.752662, 34.764402);
        map.centerAndZoom(point, 15);
        window.map = map;
    }
    var markerArr = [{
        title: "e-BABY台湾精致早教",
        content: "电 话：0371-53333832<br>地 址：郑东新区万安街6号(黄河南路万安街与兴荣街交叉口)",
        point: "113.752662|34.764402",
        isOpen: 1,
        icon: {
            w: 23,
            h: 25,
