...
<head>
    ...
    <link rel="stylesheet" href="<?php echo esc_url( get_template_directory_uri() ); ?>/css/school.css">
        ...
        <div class="head">
            <div class="head-con">
                ...
                <ul class="head-lis">
                    ...
                    <li><a href="https://www.gy720.com/pano/view/9986" target="_blank">全景校园</a>
                        <div class="line"></div>
                    </li>
        ...
        <div class="s-content">
            <div class="s-slider">
                <div class="swiper-wrapper s-img">
                    <div class="swiper-slide s-slide1 gjzxBanner1"></div>
                    <!-- <div class="swiper-slide s-slide2"></div> -->
                </div>
            </div>
            <div class="s-intro">
                <div class="s-intro-head">
                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/school/logo_gjzx.png" alt="" data-aos="flip-up" data-aos-duration="600">
                    <h3 data-aos="fade-down" data-aos-duration="600">经济技术开发区育人学校</h3>
                    <h4 data-aos="fade-down" data-aos-duration="600">勇于优秀 敢于担当</h4>
                </div>
                <div class="s-intor-con" data-aos="fade-up" data-aos-duration="600">
                    <div class="s-intor-con-left">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/school/logo_gjzx.png" alt="">
                    </div>
                    <div class="s-intro-con-rig">
                        <p>学校位于经开区第五大街与经南二路交叉口，现有1000余名学生。一至二年级每班20-25名学生，三至六年级每班25-30名学生，
                            实行小班化教学。学校按照国家课程标准开齐所有基础课程，并开设有自己的特色课程。从一年级就开设英语和外教口语课，
                            以及各种特长班三十余种。校园文化丰富，做到了绿化、美化、净化，人文气息浓郁。</p>
                        <p>现沪豫强强联合，学校引进了上海世界外国语小学IB-PYP国际英语项目，为学生提供智力、情感、个人发展、
                            社会技能等方面的英语教育，使其获得英语学习、工作以及生活的各项能力。</p>
                    </div>
                </div>
            </div>
                ...
                <ul class="s-choice-con clearfix">
                    <li data-aos="fade-up" data-aos-duration="500">
                        <div class="s-choice-lis">
                            ...
                            <div class="s-choice-p">
                                <p>学校以小班教学和双语教学为主要特色，受到学生和家长的高度评价。学校注重学生全方位的成长教育，不仅用知识丰富他们，
                                    还让他们在学习的过程中不断开拓视野，汲取中西文化的精华，从而树立良好的态度和世界公民的责任感。</p>
                            </div>
                        </div>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="200">
                        <div class="s-choice-lis">
                            ...
                            <h4>小班教学 更多关注</h4>
                            <div class="s-choice-p">
                                <p>在每20到30人为单位的小班中，孩子们将得到老师和同学的更多关注，并有机会用纯正的英语和外籍老师面对面沟通。在寄宿生活环境中，
                                    孩子们有更多的机会观察身边的老师和同学，学习他们身上的长处和优点，学会尊重、学会感恩、学会回馈，也因此而变得更加独立。</p>
                            </div>
                        </div>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="400">
                        <div class="s-choice-lis">
                            ...
                            <h4>国际合作 STEAM课程</h4>
                            <div class="s-choice-p">
                                <p>和美国爱因斯坦学院合作，成为其在中国的第一个校区和中国总部所在地。引进了S.T.E.A.M课程体系，通过跨学科的教
                                    育体验和富含科技、视觉表演艺术和领导力的教育体系，为幼儿和青少年提供创造服务于社会的机会和习得世界语言的环境，
                                    使他们从小就具有适应于21世纪生活和工作的能力。</p>
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <div class="section s-show" id="schoolShow">
                ...
                <div data-aos="fade-up" data-aos-duration="500">求知 • 求实 • 求真 • 求善 • 求美</div>
                <ul class="s-show-con">
					<?php $all_img = get_xc('校园风采'); ?>
...
<script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/school-map.js"></script>
<script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/img-hover.js"></script>
<script>
    function createMap() {
        var map = new BMap.Map("dituContent");

        var point = new BMap.Point(113.761346,34.72479);
        map.centerAndZoom(point, 15);
        window.map = map;
    }
    var markerArr = [{
        title: "经济技术开发区育人学校",
        content: "电 话：0371-62005531 62005169<br>地 址：经开区第五大街与经南二路交叉口",
        point: "113.761346|34.72479",
        isOpen: 1,
        icon: {
            w: 23,
            h: 25,
