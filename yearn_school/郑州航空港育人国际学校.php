        ...
        <div class="s-content">
            <div class="s-slider">
                <div class="swiper-wrapper s-img">
                    <div class="swiper-slide s-slide1 gjzzBanner"></div>
                    <!-- <div class="swiper-slide s-slide2"></div> -->
                </div>
            </div>
            <div class="s-intro">
                <div class="s-intro-head">
                    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/school/logo_gjzz.png" alt="" data-aos="flip-up" data-aos-duration="600">
                    <h3 data-aos="fade-down" data-aos-duration="600">郑州航空港育人国际学校</h3>
                    <h4 data-aos="fade-down" data-aos-duration="600">心智合一 博雅致远</h4>
                </div>
                <div class="s-intor-con" data-aos="fade-up" data-aos-duration="600">
                    <div class="s-intor-con-left">
                        <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/school/logo_gjzz.png" alt="">
                    </div>
                    <div class="s-intro-con-rig">
                        <p>郑州航空港育人国际学校占地132亩，建筑面积12万平方米，总投资规模达3.2亿元。学校设有幼教部、小学部、
                            中学部（初中、高中）一站式品质教育服务。一流的校园环境、整洁的餐厅、高标准的寝室保证了学生高品质的学习环境；
                            宽阔的运动场、现代化形体教室、钢琴室、计算机室、读书广场等，为学生全面提高综合素质提供了硬件保障。
                            学校地处郑州航空港区南部，空气清新，环境雅致。远离闹市而又毗邻市区，清静而又不闭塞，是个潜心读书做学问的好地方。
                        </p>
                    </div>
                </div>
            </div>
                ...
                <ul class="s-choice-con clearfix">
                    <li data-aos="fade-up" data-aos-duration="500">
                        <div class="s-choice-lis">
                            ...
                            <div class="s-choice-p">
                                <p>以“为每一位学生提供适合的教育”为目标，我们设计了30多种校本课程，孩子们可以根据个人兴趣进行选择，
                                    从而全方位地提高其综合素质。孩子们是一棵棵幼苗，我们愿意当好园丁，让他们未来长成参天大树；
                                    孩子们是一块块璞玉，我们愿意当好雕刻师，让他们成为无价之宝。</p>
                            </div>
                        </div>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="200">
                        <div class="s-choice-lis">
                            ...
                            <h4>男女分班 针对教育</h4>
                            <div class="s-choice-p">
                                <p>男生班开设拳击、散打、武术、体操、游泳、长跑、野外生存训练等非传统性活动，让男生有更多的享受作为一个男孩成长必须的学习、生活、锻炼的时间。
                                </p>
                                <p>女生班开设少女课堂、艺术体操、瑜伽形体、成才女性、女性与审美、女性与礼仪等课程，让女生备良好素养、内涵，造就知性、智慧、从容，大气的女生。</p>
                            </div>
                        </div>
                    </li>
                    <li data-aos="fade-up" data-aos-delay="400">
                        <div class="s-choice-lis">
                            ...
                            <h4>国际课程，小班教学</h4>
                            <div class="s-choice-p">
                                <p>创新型教育模式，全面培养学生的自理能力和自主意识。强化对学生的行为规范，提出“生活快节奏，行动军事化，学习高效率”，并制订《校园安全无间隙管理方案》，
                                    全面实践全员育人导师制，实现“时时有人管，事事有人管，安全无死角”的管理目标。
                                </p>
                            </div>
                        </div>
                    </li>
...
<script>
    function createMap() {
        ...
        var point = new BMap.Point(113.843399, 34.489585);
        map.centerAndZoom(point, 15);
        window.map = map;
    }
    var markerArr = [{
        title: "郑州航空港育人国际学校",
        content: "电 话：0371-62005531 62005169<br>地 址：郑州市新郑市新港办事处枣岗村航兴路东300米",
        point: "113.843399|34.489585",
        isOpen: 1,
        icon: {
            w: 23,
            h: 25,
